...
#ifndef DIARY_WEBAPP_SWIFT_H
#define DIARY_WEBAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="diary_webapp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12diary_webapp11AppDelegate")
...
SWIFT_CLASS("_TtC12diary_webapp17MainFlutterWindow")
